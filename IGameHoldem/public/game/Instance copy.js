...
// for ( let i in cPlayerLocations)
// {
//     const cIndex = parseInt(EPositionIndex.Player1)+parseInt(i);

//     configScreen.listDesktopLocationsH.push({x:configScreen.GetPosition(cIndex).x, y:configScreen.GetPosition(cIndex).y});
//     configScreen.listDesktopLocationsV.push({x:cPlayerVerticalLocations[i].x+20, y:cPlayerVerticalLocations[i].y+20});
