export default class IImage{
    ...
    RenderLS(ctx, x, y, scale, angle)
    {
        ...
        ctx.drawImage(
            ...
            this.iCurrentX, 
            this.iCurrentY, 
            parseInt(this.iCurrentWidth*scale), 
            parseInt(this.iCurrentHeight*scale));
    }
    ...
    CardRenderTurn(ctx, x, y, kTimer, strDeckCode, sprite)
    {
        this.iCurrentX = x*this.fHR;
        this.iCurrentY = y*this.fVR;
        ...
        else if ( this.iDirection == 1 )
        {
            ...
            if ( this.iCurrentWidth > (this.width*this.fHR) ) this.iCurrentWidth = this.width*this.fHR;
            this.iCurrentX = (x*this.fHR) + ((this.width*this.fHR)-this.iCurrentWidth)*0.5;
        }
